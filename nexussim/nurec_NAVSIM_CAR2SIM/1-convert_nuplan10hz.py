...
SENSOR_ROOT = os.environ.get("NUPLAN_SENSOR_ROOT", "/avl-west/nuplan/nuplan-v1.1/sensor_blobs")
MAPS_ROOT = os.environ.get("NUPLAN_MAPS_ROOT", "/avl-west/nuplan/maps")
# OUT_ROOT/<token>/clips/<token>/pai_<token>.json is where NCoreBridge writes.
# The batch orchestrator sets this to /avl-west/navsafe/ncore.
OUT_ROOT = os.environ.get("NAVSAFE_NCORE_ROOT", "/avl-west/r2s_work")
