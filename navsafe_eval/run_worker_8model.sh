...
# need. Built fresh on this pod's ephemeral /root, same as /root/nexussim-venv above
...
if grep -qE '^(recogdrive_il|recogdrive_rl|mtdrive_sft|mtdrive_mtgrpo|autovla|drivelaw)\b' "$MODELS_TSV"; then
