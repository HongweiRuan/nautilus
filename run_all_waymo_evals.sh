...
echo "=== eval_waymo_ego_cali_v1: dd ==="
cd /Users/hongwei/Desktop/avl/nautilus/eval_waymo_ego_cali_v1
bash bash_waymo_eval_dd_ego_v1.sh

echo "=== eval_waymo_ego_cali_v1: ddv2 ==="
bash bash_waymo_eval_ddv2_ego_v1.sh

echo "=== eval_waymo_ego_cali_v1: rap ==="
bash bash_waymo_eval_rap_ego_v1.sh
