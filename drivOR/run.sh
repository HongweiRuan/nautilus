conda activate /workspace/anaconda_persistent/envs/drivoR
apt-get update
...
export NUPLAN_MAPS_ROOT="/workspace/avl_west/nuplan/maps"
export NAVSIM_EXP_ROOT="/workspace/closed_loop_e2e/drivor-exp"
export NAVSIM_DEVKIT_ROOT="/workspace/DrivoR"
export OPENSCENE_DATA_ROOT="/workspace/avl_west/navsim"
...
python $NAVSIM_DEVKIT_ROOT/navsim/planning/script/run_training_full.py  \
    ...
    navsim_log_path=/workspace/avl_west/navsim/trainval_navsim_logs/trainval \
    train_test_split.data_split=trainval \
    +train_test_split.log_splits=null \
    cache_path=/workspace/closed_loop_e2e/drivor-exp/navsim_cache_nommcv \
    use_cache_without_dataset=true \
    sensor_blobs_path=/workspace/avl_west/navsim/trainval_sensor_blobs/trainval \
